...
start "DeepLiveCam UI" "%ROOT%python\python.exe" "%ROOT%run.py" --execution-provider cuda --execution-threads 2 --frame-processor face_swapper face_enhancer_gpen256 --live-resizable --live-fps-debug --similar-face-distance 1.5 --quality-preset balanced -l zh
