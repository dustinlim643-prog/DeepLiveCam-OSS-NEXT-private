...
$scene.settings.items[0].pos.x = 437.0
...
$scene.settings.items[0].scale.x = 1.0
$scene.settings.items[0].scale.y = 1.0
$scene.settings.items[0].scale_rel.x = 1.0
$scene.settings.items[0].scale_rel.y = 1.0
$scene.settings.items[0].bounds.x = 405.0
$scene.settings.items[0].bounds.y = 720.0
...
Write-Output "OBS mobile scene rebuilt as a centered 9:16 image inside a compatible 1280x720 camera stream."
